...
document.addEventListener("DOMContentLoaded", async () => {
    console.log("Silence Remover - v2.1.1")
    ...
    processButton.addEventListener("click", async () => {
        ...
        for (let i = 0; i < filesArray.length; i++) {
            ...
            try {
                ...
                await ffmpeg.run("-i", tempWav, "-af", "volume=2.0, highpass=f=200, lowpass=f=3000, silenceremove=start_periods=1:start_threshold=-40dB:start_silence=1.5:stop_threshold=-40dB:stop_silence=2:stop_periods=-1", cleanedWav);
